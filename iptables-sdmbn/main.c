...
{
    printf("FAST: I was inside the callback");
    fast_test = 10;
...
//	printf("FAST: connkey.tp_src = %d\n", connkey.tp_src);
//	printf("FAST: connkey.tp_dst = %d\n", connkey.tp_dst);
//	printf("FAST: connkey.nw_src = %d\n", connkey.nw_src);
//	printf("FAST: connkey.nw_dst = %d\n", connkey.nw_dst);
//	printf("FAST: hashkey = %d\n", hashkey);
//	printf("FAST: get_count = %d\n",get_count);
...
//    printf("\nFAST: I am in local_get_perflow\n");
    if (NULL == key)
    { printf("FAST: key");  return -1; }
	...
	if (family==AF_INET)
	{
//	    printf("FAST: IP info: %d %d %d", key->nw_proto, key->nw_src, key->nw_src_mask);
		//IPv4
...
//    }
//
//    printf("\nFAST: I was right before local get perflow state\n");
    // Register call back
    struct get_perflow_args args;
    args.key = key;
    args.id = id;
...
//    printf("\nFAST: I was right after local get perflow state %d\n", fast_cb);
