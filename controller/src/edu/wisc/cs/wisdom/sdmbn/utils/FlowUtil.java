...
public class FlowUtil 
{
	...
	private static final short STATE_COOKIE = 7;   // for fast
	...
	// this support multiport actions
	public static void installForwardingRules(IOFSwitch sw, short inPort, 
			short[] outPorts, PerflowKey key)
	{
		...
		long cookie = AppCookie.makeCookie(STATE_COOKIE, 0);   // for fast
		...
		rule.setCookie(cookie);  // for fast
