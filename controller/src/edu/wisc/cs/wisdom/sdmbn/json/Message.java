...
public class Message 
{
	...
	public static final String FIELD_STATEIP = "stateIp";    // for FAST
 	public static final String FIELD_STATEPORT = "statePort";  // for FAST
	...
	public static final String COMMAND_PUT_DESTINATION_INFO = "put-destinfo";   // for FAST



	public static final String COMMAND_SEND_LOCAL_HOST_INFO = "send-local-hostinfo";  // for FAST
	...
	public static final String EXT_RESPONSE_SYN = "ext-syn";
