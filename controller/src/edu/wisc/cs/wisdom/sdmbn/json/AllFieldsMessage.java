...
//	public Middlebox destMb;
	...
	public Message cast() throws MessageException
	{
		...
		if (this.type.equals(Message.EXT_RESPONSE_SYN))
		{ return new ExtSynMessage(this); }

		if (this.type.equals(Message.COMMAND_PUT_DESTINATION_INFO))
		{ return new DestinationInfoMessage(this); }
